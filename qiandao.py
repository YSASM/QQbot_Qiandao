...
img = Image.open(r'C:\Users\Administrator\Desktop\moyao\plugins\pyPlugins\config\qiandao.png')
temp=[]
temp2=[]
listAll=[]
def readTXT():
    with open(r'C:\Users\Administrator\Desktop\moyao\plugins\pyPlugins\config\qiandaoINFO.txt','r',encoding='utf-8') as file:
...
def writeTXT():
    ...
    count2=1
    l =listAll.__len__()
    with open(r'C:\Users\Administrator\Desktop\moyao\plugins\pyPlugins\config\qiandaoINFO.txt','w',encoding='utf-8') as file:
        file.truncate(0)
        for i in listAll:
            for j in i:
                if count<4:
